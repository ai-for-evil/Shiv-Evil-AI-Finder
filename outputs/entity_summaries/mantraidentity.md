...
- ewswire/globenewswire/mantra-softech-extends-licence-for-fpc-iris-technology-to-expand-into-new-markets/2100345 https://mantraidentity.com/Assets/Images/Company_Profile.pdf https://cis-india.org/internet-governance/blog/table-2.pdf ['https://www.mantratec.com/'] MASL (Millennium Automation Systems Limited, and formerly known as MAPL World) is a technology company that provides surveillance and smart city products. For the Delhi Police, MASL implemented a citywide surveillance system that uses Facial Recognition Systems (FRS) and Automatic License P
